...
answer — 그 물음에 대한 답. 두세 문장의 한국어 문단으로 적는다.
이야기가 실제로 말한 것에서 출발해, 그 일이 없었다면 무엇이 이어지지
못했을지를 잇는다. 물음을 되풀이하지 않는다.

possibilities — 갈렸을 길을 짧은 구절로 나열한다.


예:

question: 창업 실패가 없었다면?

answer: 실패가 없었다면 그 회사에 남아 조직을 키우는 쪽으로 갔을 것이다.
독립해서 혼자 만드는 방식은 그 실패 뒤에 생긴 것이라, 지금의 일하는
태도와 그때 만난 사람들은 자리를 달리했을 수 있다.
...
answer 를 비워 두지 않는다 — 물음만 있으면 화면에 물음표만 선다.
